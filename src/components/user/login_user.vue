<template>
    <div >
        <div class="font-bold text-3xl text-gray-800 flex justify-center items-center">客户欢迎回来</div>
        ...
        <div>
          <el-form :model="form" class="w-[250px]">
            ...
            <div class="demo-form-inline">
                ...
                <el-link href="http://localhost:5173/#/forget_password" target="_self">忘记密码?</el-link>
              </div>

            <el-form-item>
              <el-button class="w-[250px]"  round type="primary" @click="onSubmit">登录</el-button>
            </el-form-item>
            <el-link href="http://localhost:5173/#/register_user" target="_self" >没有账号？立即注册</el-link>
          </el-form>
        </div>
      </div>
</template>
...
var naid = localStorage.getItem("user"); //获取指定key本地存储的值
...
axios.post( 'user/login'+'?email='+form.email+'&password='+form.password).then(
  success=>{
    console.log(success);
